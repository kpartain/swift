...
#ifndef SALESTAX_SWIFT_H
#define SALESTAX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SalesTax",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8SalesTax11AppDelegate")
...
SWIFT_CLASS("_TtC8SalesTax13SceneDelegate")
...
SWIFT_CLASS("_TtC8SalesTax14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified finalResult;
- (void)viewDidLoad;
- (IBAction)beforeTax:(UITextField * _Nonnull)sender;
- (IBAction)taxRateGiven:(UITextField * _Nonnull)sender;
